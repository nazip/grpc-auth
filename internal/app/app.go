...
import (
	...
	descAccess "github.com/nazip/grpc-auth/pkg/access_v1"
	descAuth "github.com/nazip/grpc-auth/pkg/auth_v1"
	descUser "github.com/nazip/grpc-auth/pkg/user_v1"

	_ "github.com/nazip/grpc-auth/statik"
	"github.com/rs/cors"
...
func NewApp(ctx context.Context, configFile string) (*App, error) {
...
func (a *App) initConfig(_ context.Context) error {
	fmt.Println(a.configFile)
	err := config.Load(a.configFile)
	if err != nil {
		return err
	}
