...
//go:generate minimock -i github.com/nazip/grpc-auth/internal/client/db.TxManager -o ./mocks/tx_manager_minimock.go -n TxManagerMock
...
import (
	...
	mm_db "github.com/nazip/grpc-auth/internal/client/db"
)
