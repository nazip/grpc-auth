...
//go:generate minimock -i github.com/nazip/grpc-auth/internal/service.UserService -o ./mocks/user_service_minimock.go -n UserServiceMock
...
type UserServiceMock struct {
	...
	funcCreate          func(ctx context.Context, user *model.User) (u1 uint64, err error)
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, user *model.User) (u1 uint64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, user *model.User) (u1 uint64, err error) {
...
func (mmGet *mUserServiceMockGet) Expect(ctx context.Context, id uint64) *mUserServiceMockGet {
...
func (mmGet *mUserServiceMockGet) Inspect(f func(ctx context.Context, id uint64)) *mUserServiceMockGet {
...
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, id uint64) (up1 *model.User, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mUserServiceMockGet) When(ctx context.Context, id uint64) *UserServiceMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *UserServiceMock) Get(ctx context.Context, id uint64) (up1 *model.User, err error) {
